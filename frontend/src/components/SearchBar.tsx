        ...
        <div className="absolute top-full mt-2 w-full bg-surface border border-slate-blue/20 rounded-card shadow-deep z-dropdown overflow-hidden animate-slide-up">
          ...
          {cities.map((city) => (
            <button
              ...
              className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-text-secondary hover:bg-surface-light hover:text-solar-orange transition-colors duration-fast text-left"
            >
